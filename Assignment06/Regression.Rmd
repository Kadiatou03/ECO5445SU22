...
```{r}
# No file exists in this location. Added dataset to location

Property <- read.csv("prop_prices_reduced.csv")

#Renaming column sale_def with an intuitive name: price

# library(dplyr) once it is referenced above, you dont need it here
...
`What about Assumption 1, 2, and 5?`
...
`Not necessarily. The data may need to be manipulated a different way.`
...
`Why didn't you use one of the better models you created?`